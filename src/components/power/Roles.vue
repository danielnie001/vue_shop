<template>
  <div>
    ...
    <!-- 分配权限的对话框 -->
    <el-dialog title="分配权限" :visible.sync="setRightDialodialogVisible" width="50%" @close="setRightDialogClosed">
      <el-tree :data="rightsList" :props="treeProps" show-checkbox node-key="id" default-expand-all :default-checked-keys="defKeys" ref="treeRef"></el-tree>
      <span slot="footer" class="dialog-footer">
        <el-button @click="setRightDialodialogVisible = false">取 消</el-button>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      roleList: [],
      // 控制分配权限对话的显示与隐藏
      setRightDialodialogVisible: false,
      // 所有权限数据列表
      rightsList: [],
      // 树形控件的属性绑定对象
      treeProps: {
  ...
  methods: {
    ...
    // 通过递归的形式获取到角色下所有三级权限的id,并保存到defKeys中
    ...
    async allotRights() {
      ...
      this.getRoleList()
      this.setRightDialodialogVisible = false
    }
  },
